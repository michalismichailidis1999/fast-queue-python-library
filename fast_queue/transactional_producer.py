...
from .responses import BeginTransactionResponse, FinalizeTransactionResponse, RegisterTransactionGroupResponse
...
class TransactionalProducer:
            ...
            try:
                while retries > 0:
                    try:
                        ...
                        self.__set_new_transaction_group_id(res.leader_id, res.transaction_group_id)
    ...
    def __set_new_transaction_group_id(self, leader_id: int, transaction_group_id: int) -> None:
